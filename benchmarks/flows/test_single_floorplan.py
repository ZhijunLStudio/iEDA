...
workspace = REPO_ROOT / f"benchmarks/results/aes13_60pct/{design_name}/workspace"
...
if "sky130" in design_name:
    ...
    cell_lef = FOUNDRY_ROOT / "asap7/lef/asap7_tech_1x_201209.lef"
    ...
    pdk = "ics55"
    tech_lef = FOUNDRY_ROOT / "ics55/lef/ics55_LLSC_H7CR.tlef"
    cell_lef = FOUNDRY_ROOT / "ics55/lef/ics55_LLSC_H7CR.lef"
    lib = FOUNDRY_ROOT / "ics55/lib/ics55_LLSC_H7CR_typ_tt_1p2_25_nldm.lib"
    site = "core7"
    tapcell = "FILLTAPH7R"
    endcap = "FILLTAPH7R"
    pin_layer = "MET3"
...
env.update({
    ...
    "TOP_NAME": "aes",
    "CLK_PORT_NAME": "clk",
    "NETLIST_FILE": str(REPO_ROOT / f"benchmarks/designs/{design_name}/netlist/aes.v"),
