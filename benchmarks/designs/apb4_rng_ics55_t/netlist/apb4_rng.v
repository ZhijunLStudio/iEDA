...
module apb4_rng ( apb4_pclk, apb4_presetn, apb4_paddr, apb4_pprot, apb4_psel, 
  ...
  sky130_fd_sc_hd__or3_1 U44 ( .A(apb4_paddr[4]), .B(apb4_paddr[5]), .C(
        apb4_paddr[2]), .X(n3) );
  sky130_fd_sc_hd__inv_2 U45 ( .A(\s_rng_ctrl_q[0] ), .Y(n1) );
  sky130_fd_sc_hd__o41ai_1 U46 ( .A1(apb4_paddr[3]), .A2(n3), .A3(n1), .A4(n7), 
        .B1(n8), .Y(apb4_prdata[0]) );
  sky130_fd_sc_hd__o2bb2ai_1 U47 ( .B1(n2), .B2(n1), .A1_N(apb4_pwdata[0]), 
        .A2_N(n2), .Y(\s_rng_ctrl_d[0] ) );
  sky130_fd_sc_hd__nor2_1 U48 ( .A(n3), .B(n4), .Y(n2) );
