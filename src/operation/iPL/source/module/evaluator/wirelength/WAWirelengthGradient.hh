...
class WAWirelengthGradient : public WirelengthGradient
{
 public:
  ...
  void updateWirelengthForceDirect(float coeff_x, float coeff_y, float min_force_bar, int32_t thread_num, GridManager* grid_manager, int32_t congestion_effort_level = 1);
