...
class LibPort : public LibObject
{
 ...
 private:
  ...
  bool _is_clock_pin = false;           //!< clock pin flag
...
{
 public:
  std::string get_when() { return _arc_when; }
  void set_arc_when(const std::string& w) { _arc_when = w; }
 private:
  std::string _arc_when;
 public:
  enum class ArcType
  {
    kDelayArc,
...
{
 public:
  double convertInternalPowerTableToMwNs(double v) { return v; }
